...
Of the 179 songs in the Isophonics Beatles collection, we found MIDI transcriptions for all but 11.
...
This affected the {\em Any Metric Level Continuous} scores the least because it is invariant to these issues, except for the handful of files which were transcribed at a third of the tempo.
